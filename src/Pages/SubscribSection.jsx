...
const SubscribeSection = () => {
    return (
        <section className="py-10 bg-gradient-to-b from-green-100 to-green-100 sm:py-16 lg:py-24">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl text-center">
                <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl transition-all duration-1000 transform hover:scale-105 hover:text-teal-500">
                    Stay Updated with Our Blog
                </h2>
                <p className="max-w-2xl mx-auto mt-4 text-base leading-relaxed text-gray-600 transition-all duration-1000 transform hover:scale-105">
