    ...
    <section class="py-10 sm:py-16 lg:py-24">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    <h1 class="text-4xl font-bold text-black sm:text-6xl lg:text-7xl">
                        ...
                        <div class="relative inline-flex">
                            ...
                            <h1 class="relative text-4xl font-bold text-black sm:text-6xl lg:text-7xl">ZahiDBlogs</h1>
                        </div>
                    </h1>

                    <p class="mt-8 text-base text-black sm:text-xl">ZahiDBlogs is where you explore new ideas, learn valuable insights, and grow your knowledge. Join us and start your journey of discovery today!</p>

                    <div class="mt-10 sm:flex sm:items-center sm:space-x-8">
                        <Link to="/blog" title="" class="inline-flex items-center justify-center px-10 py-4 text-base font-semibold text-white transition-all duration-200 bg-orange-500 hover:bg-orange-600 focus:bg-orange-600" role="button"> Start exploring </Link>
                ...
                <div>
                    <img class="w-full" src="https://i.ibb.co.com/GQTCCBvh/undraw-online-articles-g9cg-removebg-preview.png" alt="" />
                </div>
            </div>
        </div>
    </section>
